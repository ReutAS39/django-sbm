# Generated by Django 4.2.2 on 2023-09-12 12:29
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('orig_title', models.CharField(blank=True, max_length=100, verbose_name='Оригинальное название')),
                ('age_rate', models.PositiveSmallIntegerField(blank=True, null=True, verbose_name='Возрастной рейтинг')),
                ('year', models.PositiveSmallIntegerField(blank=True, null=True, verbose_name='Год производства')),
                ...
                ('gross_worldwide', models.PositiveSmallIntegerField(blank=True, default=0, null=True, verbose_name='Сборы в мире')),
                ('world_premiere', models.DateField(blank=True, null=True, verbose_name='Премьера в мире')),
                ('runtime', models.PositiveSmallIntegerField(blank=True, null=True, verbose_name='Хронометраж')),
                ('description', models.TextField(verbose_name='Обзор')),
                ('poster', models.ImageField(null=True, upload_to='film/poster/%Y/%m/%d/', verbose_name='Постер')),
            ],
        ),
        migrations.CreateModel(
            name='Genre',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('orig_name', models.CharField(blank=True, max_length=255, unique=True, verbose_name='Оригинальное имя')),
        ...
        migrations.AddField(
            model_name='film',
            name='genre',
            field=models.ManyToManyField(blank=True, related_name='film_genre', through='movies.FilmGenre', to='movies.genre', verbose_name='Жанр'),
        ),
        migrations.AddField(
            model_name='film',
            name='operator',
